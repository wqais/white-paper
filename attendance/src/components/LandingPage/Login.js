  ...
  return (
    <div className=" ">
      ...
      <ToastContainer
        ...
        pauseOnHover
      />
      <div className="flex justify-center  min-h-full items-center  py-12 px-4 sm:px-6 lg:px-8 mt-[0%] px-[5%] bg-center">
            ...
            <TabPanel value="1">
              ...
              >
                ...
                <h2>
                  ...
                  <Link href="/registerStudent">Register Now</Link>
                </h2>
              </form>
            </TabPanel>
            <TabPanel value="2">
              <form className=" space-y-6" action="#" method="POST">
                ...
                <h2>
                  Don't have an account?{" "}
                  <Link href="/registerTeacher">Register Now</Link>
                </h2>
              </form>
            </TabPanel>
          </TabContext>
